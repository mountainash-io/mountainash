...
Naming convention:
- {Type}{Category}ExpressionProtocol: e.g., ScalarArithmeticExpressionProtocol, AggregateArithmeticExpressionProtocol
"""
...
class ScalarArithmetic_DecimalExpressionProtocol(Protocol):
...
class ScalarBooleanExpressionProtocol(Protocol):
    """Protocol for scalar boolean operations.
...
class ScalarGeometryExpressionProtocol(Protocol):
...
class ScalarRounding_DecimalExpressionProtocol(Protocol):
...
class ScalarStringExpressionProtocol(Protocol):
...
# =============================================================================
# Aggregate Function Protocols
# =============================================================================


class AggregateAggregate_ApproxExpressionProtocol(Protocol):
...
class AggregateAggregate_GenericExpressionProtocol(Protocol):
...
class AggregateAggregate_DecimalExpressionProtocol(Protocol):
...
class AggregateArithmeticExpressionProtocol(Protocol):
...
class AggregateArithmetic_DecimalExpressionProtocol(Protocol):
...
class AggregateBooleanExpressionProtocol(Protocol):
...
class AggregateDatetimeExpressionProtocol(Protocol):
...
class AggregateStringExpressionProtocol(Protocol):
...
# =============================================================================
# Window Function Protocols
# =============================================================================


class WindowArithmeticExpressionProtocol(Protocol):
    ...
    def row_number(self) -> SupportedExpressions:
    ...
    def rank(self) -> SupportedExpressions:
    ...
    def dense_rank(self) -> SupportedExpressions:
    ...
    def percent_rank(self) -> SupportedExpressions:
    ...
    def cume_dist(self) -> SupportedExpressions:
    ...
    def ntile(self, x: SupportedExpressions) -> SupportedExpressions:
    ...
    def first_value(self, expression: SupportedExpressions) -> SupportedExpressions:
    ...
    def last_value(self, expression: SupportedExpressions) -> SupportedExpressions:
    ...
    def nth_value(self, expression: SupportedExpressions, window_offset: SupportedExpressions, on_domain_error: Any = None) -> SupportedExpressions:
...
The `on_domain_error` option governs behavior in cases where `window_offset` is not a positive integer or `null`.
    ...
    def lead(self, expression: SupportedExpressions) -> SupportedExpressions:
...
Example comparing the sales of the current year to the following year. `row_offset` of 1. | year | sales  | next_year_sales | | 2019 | 20.50  | 30.00           | | 2020 | 30.00  | 45.99           | | 2021 | 45.99  | null            |
    ...
    def lag(self, expression: SupportedExpressions) -> SupportedExpressions:
