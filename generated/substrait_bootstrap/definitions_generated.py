...
If the in...
    ...
    all_functions = (
        COMPARISON_FUNCTIONS + BOOLEAN_FUNCTIONS + ARITHMETIC_FUNCTIONS + STRING_FUNCTIONS + DATETIME_FUNCTIONS + ROUNDING_FUNCTIONS + LOGARITHMIC_FUNCTIONS + AGGREGATE_GENERIC_FUNCTIONS + AGGREGATE_APPROX_FUNCTIONS
    )
