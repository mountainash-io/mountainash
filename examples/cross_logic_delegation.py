...
from mountainash_expressions.constants import CONST_LOGIC_TYPES
...
def demonstrate_visitor_delegation():
    ...
    current_logic_type = CONST_LOGIC_TYPES.BOOLEAN
    ...
    if should_delegate:
        ...
        delegate_visitor = create_delegate_visitor(
            table=df,
            target_logic_type=CONST_LOGIC_TYPES.TERNARY,
