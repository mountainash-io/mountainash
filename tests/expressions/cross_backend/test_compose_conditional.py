...
class TestComposeConditional:
    ...
    def test_conditional_string_transform(self, backend_name, backend_factory, collect_expr):
    ...
    def test_conditional_arithmetic(self, backend_name, backend_factory, collect_expr):
    ...
    def test_conditional_null_handling(self, backend_name, backend_factory, collect_expr):
    ...
    def test_conditional_composed_condition(self, backend_name, backend_factory, collect_expr):
