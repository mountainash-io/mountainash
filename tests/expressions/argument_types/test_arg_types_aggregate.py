"""Argument channel coverage for aggregate operations.

Aggregate fixtures are not exercised here because this matrix supplies eager
frames while the covered aggregate forms require relation-level execution.
"""
