...
_KNOWN_UNTESTED_OPTION_PARAMS: dict[tuple[str, str, str], KnownGap] = {
    ...
    for key in {
        ...
        ("MountainAshScalarDatetimeExpressionSystemProtocol", "ceil_dt", "unit"),
        ...
        ("MountainAshScalarDatetimeExpressionSystemProtocol", "floor_dt", "unit"),
        ...
        ("MountainAshScalarDatetimeExpressionSystemProtocol", "round_dt", "unit"),
