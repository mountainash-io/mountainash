...
Generated: 2025-12-02T10:55:05.407659

## Summary

Total functions: **193**

- aggregate_approx: 1 functions
- aggregate_generic: 3 functions
- aggregate_decimal: 3 functions
- arithmetic: 46 functions
- arithmetic_decimal: 17 functions
- boolean: 7 functions
- comparison: 24 functions
- datetime: 20 functions
- geometry: 19 functions
- logarithmic: 5 functions
- rounding: 3 functions
- rounding_decimal: 3 functions
- set: 1 functions
- string: 41 functions
