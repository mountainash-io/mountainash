...
def register_substrait_functions() -> None:
    ...
    # ========================================
    # Aggregate_Approx Functions (1 functions)
    # ========================================

    AGGREGATE_APPROX_FUNCTIONS = [
        FunctionDef(
            name="approx_count_distinct",
            substrait_uri=SubstraitExtension.AGGREGATE_APPROX_AGG,
            substrait_name="approx_count_distinct",
            backend_method="approx_count_distinct",  # TODO: verify backend method name
            category="aggregate_approx_agg",
            n_args=1,
    ...
    # ========================================
    # Aggregate_Generic Functions (3 functions)
    # ========================================

    AGGREGATE_GENERIC_FUNCTIONS = [
        FunctionDef(
            name="count",
            substrait_uri=SubstraitExtension.AGGREGATE_GENERIC_AGG,
            substrait_name="count",
            backend_method="count",  # TODO: verify backend method name
            category="aggregate_generic_agg",
            n_args=1,
            options=('overflow',),
...
If the in...
    ...
    # ========================================
    # Aggregate_Decimal Functions (3 functions)
    # ========================================

    AGGREGATE_DECIMAL_FUNCTIONS = [
        FunctionDef(
            name="count",
            substrait_uri=SubstraitExtension.AGGREGATE_DECIMAL_AGG,
            substrait_name="count",
            backend_method="count",  # TODO: verify backend method name
            category="aggregate_decimal_agg",
            n_args=1,
            options=('overflow',),
            protocol_method=UnknownProtocol.count,  # TODO: verify exists
    ...
    # ========================================
    # Arithmetic Functions (46 functions)
    # ========================================
...
...
        ...
        FunctionDef(
            name="sum",
            substrait_uri=SubstraitExtension.ARITHMETIC_AGG,
            substrait_name="sum",
            backend_method="sum",  # TODO: verify backend method name
            category="arithmetic_agg",
            n_args=1,
            options=('overflow',),
...
N...
        ...
        FunctionDef(
            ...
            n_args=1,
            options=('overflow',),
            protocol_method=UnknownProtocol.product,  # TODO: verify exists
        ...
        FunctionDef(
            ...
            protocol_method=UnknownProtocol.std_dev,  # TODO: verify exists
        ...
        FunctionDef(
            ...
            n_args=1,
            options=('rounding', 'distribution'),
            protocol_method=UnknownProtocol.variance,  # TODO: verify exists
        ...
        FunctionDef(
            ...
            n_args=2,
            options=('rounding',),
            protocol_method=UnknownProtocol.corr,  # TODO: verify exists
        ...
        FunctionDef(
            ...
            category="arithmetic_agg",
            n_args=1,
            protocol_method=UnknownProtocol.mode,  # TODO: verify exists
        ...
        FunctionDef(
            ...
            n_args=2,
            options=('rounding',),
            protocol_method=UnknownProtocol.median,  # TODO: verify exists
...
Returns null if ap...
        ...
        FunctionDef(
            ...
            n_args=4,
            options=('rounding',),
            protocol_method=UnknownProtocol.quantile,  # TODO: verify exists
...
This function will...
    ...
    # ========================================
    # Arithmetic_Decimal Functions (17 functions)
    # ========================================

    ARITHMETIC_DECIMAL_FUNCTIONS = [
        FunctionDef(
            name="add",
        ...
        FunctionDef(
            name="sum",
            substrait_uri=SubstraitExtension.ARITHMETIC_DECIMAL_AGG,
            substrait_name="sum",
            backend_method="sum",  # TODO: verify backend method name
            category="arithmetic_decimal_agg",
            n_args=1,
            options=('overflow',),
            protocol_method=UnknownProtocol.sum,  # TODO: verify exists
            # Sum a set of values....
...
When a null is input, a null i...
        ...
        FunctionDef(
            name="bool_and",
            substrait_uri=SubstraitExtension.BOOLEAN_AGG,
            substrait_name="bool_and",
            backend_method="bool_and",  # TODO: verify backend method name
            category="boolean_agg",
            n_args=1,
            protocol_method=UnknownProtocol.bool_and,  # TODO: verify exists
        ...
        FunctionDef(
            ...
            category="boolean_agg",
            n_args=1,
            protocol_method=UnknownProtocol.bool_or,  # TODO: verify exists
    ...
    # ========================================
    # Comparison Functions (24 functions)
    # ========================================
...
If `x` is `null`, `null` is ret...
    ...
    # ========================================
    # Datetime Functions (20 functions)
    # ========================================
...
Timezone strings...
        ...
        FunctionDef(
            name="min",
            substrait_uri=SubstraitExtension.DATETIME_AGG,
            substrait_name="min",
            backend_method="min",  # TODO: verify backend method name
            category="datetime_agg",
            n_args=1,
            protocol_method=UnknownProtocol.min,  # TODO: verify exists
            # Min a set of values....
        ),
    ...
    # ========================================
    # Geometry Functions (19 functions)
    # ========================================
...
Fo...
    ...
    # ========================================
    # Logarithmic Functions (5 functions)
    # ========================================
...
...
    ...
    # ========================================
    # Rounding Functions (3 functions)
    # ========================================
...
...
    ...
    # ========================================
    # Rounding_Decimal Functions (3 functions)
    # ========================================

    ROUNDING_DECIMAL_FUNCTIONS = [
        FunctionDef(
            name="ceil",
...
The `ca...
        ...
        FunctionDef(
            name="string_agg",
            substrait_uri=SubstraitExtension.STRING_AGG,
            substrait_name="string_agg",
            backend_method="string_agg",  # TODO: verify backend method name
            category="string_agg",
            n_args=2,
            protocol_method=UnknownProtocol.string_agg,  # TODO: verify exists
    ...
    all_functions = (
        AGGREGATE_APPROX_FUNCTIONS + AGGREGATE_GENERIC_FUNCTIONS + AGGREGATE_DECIMAL_FUNCTIONS + ARITHMETIC_FUNCTIONS + ARITHMETIC_DECIMAL_FUNCTIONS + BOOLEAN_FUNCTIONS + COMPARISON_FUNCTIONS + DATETIME_FUNCTIONS + GEOMETRY_FUNCTIONS + LOGARITHMIC_FUNCTIONS + ROUNDING_FUNCTIONS + ROUNDING_DECIMAL_FUNCTIONS + SET_FUNCTIONS + STRING_FUNCTIONS
    )
