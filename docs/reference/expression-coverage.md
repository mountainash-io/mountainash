...
| MA-CONF-04 | engine_leniency | pandas, narwhals-pandas, ibis-sqlite | — | pandas/narwhals-pandas cannot strictly conform mapping-valued object columns, and ibis-sqlite cannot construct struct-typed tables | compiled OBJECT/ARRAY validation cannot receive a native structured source on pandas/narwhals-pandas (IntCastingNaNError) or ibis-sqlite (UnsupportedBackendType); polars, narwhals-polars, ibis-duckdb, and ibis-polars execute it | Use a polars, narwhals-polars, ibis-duckdb, or ibis-polars backend until canonical JSON structured ingress is implemented | — | 2026-08-18 |
