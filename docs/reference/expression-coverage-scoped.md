...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ibis-sqlite | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'throw' | ibis-sqlite cannot enforce throw-on-invalid boolean tokens | — | — | 2026-08-25 | — | — |

### `CAST` × narwhals (FKEY_MOUNTAINASH_SCALAR_CATEGORICAL)

| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| narwhals-lazy | value_type | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND value_type == 'integer' | This backend cannot execute CATEGORICAL.CAST for the requested value type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-pandas | value_type | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND value_type == 'integer' | This backend cannot execute CATEGORICAL.CAST for the requested value type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-polars | value_type | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND value_type == 'integer' | This backend cannot execute CATEGORICAL.CAST for the requested value type and failure behavior | — | — | 2026-08-24 | — | — |

### `CAST` × ibis (FKEY_MOUNTAINASH_SCALAR_CATEGORICAL)

| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ibis-sqlite | value_type | — | — | unsupported | gate | build | — | value_type == 'integer' | This backend cannot execute CATEGORICAL.CAST for the requested value type and failure behavior | — | — | 2026-08-24 | — | — |
...
| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| * | format | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND format == 'array' AND source_representation == 'native' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| * | format | — | — | unsupported | gate | build | — | format == 'array' AND source_representation == 'lexical' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| * | format | — | — | unsupported | gate | build | — | format == 'object' AND source_representation == 'native' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| * | format | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND format == 'array' AND source_representation == 'native' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| * | format | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND format == 'object' AND source_representation == 'native' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| * | format | — | — | unsupported | gate | build | — | format == 'array' AND source_representation == 'lexical' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| ibis-sqlite | format | — | — | unsupported | gate | build | — | failure_behavior == 'throw' AND format == 'default' AND source_representation == 'lexical' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| ibis-sqlite | format | — | — | unsupported | gate | build | — | format == 'array' AND source_representation == 'native' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
| ibis-sqlite | format | — | — | unsupported | gate | build | — | format == 'object' AND source_representation == 'native' | This backend cannot execute the requested geospatial operation cell | — | — | 2026-08-21 | — | — |
...
| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| narwhals-lazy | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'boolean' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-lazy | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'date' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-lazy | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'integer' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-lazy | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'number' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
...
| narwhals-pandas | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'boolean' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-pandas | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'date' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-pandas | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'integer' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-pandas | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'number' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
...
| narwhals-polars | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'boolean' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-polars | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'date' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-polars | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'integer' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-polars | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'number' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
...
| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ibis-duckdb | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'boolean' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| ibis-duckdb | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'date' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| ibis-duckdb | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'integer' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| ibis-duckdb | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'number' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
| ibis-duckdb | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' AND item_type == 'time' | This backend cannot execute LIST.PARSE for the requested item type and failure behavior | — | — | 2026-08-24 | — | — |
...
| narwhals-pandas | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'throw' | This backend cannot execute STRUCT.CAST for the requested failure behavior | — | — | 2026-08-24 | — | — |
| narwhals-polars | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' | This backend cannot execute STRUCT.CAST for the requested failure behavior | — | — | 2026-08-24 | — | — |

### `CAST` × ibis (FKEY_MOUNTAINASH_SCALAR_STRUCT)

| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ibis-duckdb | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' | This backend cannot execute STRUCT.CAST for the requested failure behavior | — | — | 2026-08-24 | — | — |
| ibis-polars | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' | This backend cannot execute STRUCT.CAST for the requested failure behavior | — | — | 2026-08-24 | — | — |
| ibis-sqlite | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'null' | This backend cannot execute STRUCT.CAST for the requested failure behavior | — | — | 2026-08-24 | — | — |
| ibis-sqlite | failure_behavior | — | — | unsupported | gate | build | — | failure_behavior == 'throw' | This backend cannot execute STRUCT.CAST for the requested failure behavior | — | — | 2026-08-24 | — | — |
...
| Dialect | Param | Option values | Value class | Level | Enforcement | Boundary | Condition | Predicate | Message | Workaround | Upstream | Since | Native errors | Probe-exempt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ibis-polars | strategy | — | — | unsupported | gate | build | — | strategy in {'forward', 'nearest'} | join_asof forward/nearest lowers to a non-equality candidate join; the ibis Polars backend rejects non-equality join predicates (TypeError: Only equality join predicates supported with pandas). | Use ibis-duckdb/ibis-sqlite, or polars/narwhals backends. | IB-REL-15 | 2026-08-18 | — | — |
