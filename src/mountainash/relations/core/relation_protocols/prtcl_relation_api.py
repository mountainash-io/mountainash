...
class RelationAPIProtocol(Protocol):
    ...
    def collect_with_drift(self, *, backend: Optional[str] = None) -> Any: ...
    ...
    def to_dataclasses(self, cls: type[_T], *, spec: Optional[Any] = None, auto_derive_schema: bool = True, apply_defaults: bool = False) -> list[_T]: ...
    def to_pydantic(self, cls: type[_T], *, spec: Optional[Any] = None, auto_derive_schema: bool = True) -> list[_T]: ...
    ...
    def to_index_of_typed_named_tuples(self, index_fields: Union[str, list[str]], *, preserve_dates: bool = False) -> dict[Any, list]: ...
