...
class SubstraitNarwhalsScalarBooleanExpressionSystem(NarwhalsBaseExpressionSystem, SubstraitScalarBooleanExpressionSystemProtocol[nw.Expr]):
    ...
    def and_(self, *args: NarwhalsExpr) -> NarwhalsExpr:
    ...
    def or_(self, *args: NarwhalsExpr) -> NarwhalsExpr:
    ...
    def not_(self, a: NarwhalsExpr, /) -> NarwhalsExpr:
        """Boolean NOT.
    ...
    def xor(self, a: NarwhalsExpr, b: NarwhalsExpr, /) -> NarwhalsExpr:
    ...
    def and_not(self, a: NarwhalsExpr, b: NarwhalsExpr, /) -> NarwhalsExpr:
