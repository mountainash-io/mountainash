        ...
        DivergenceManifestation(
            key=ManifestationKey(
                ...
                scenario=Scenario(
                    ...
                    execution=(("shape", CaptureValue(tag="text", value="cum_count non-null values")),),
                ),
            ),
            kind=DivergenceKind.ENGINE_LENIENCY,
            expected=CaptureValue(
        ...
        DivergenceManifestation(
            key=ManifestationKey(
                ...
                scenario=Scenario(
                    ...
                    execution=(("shape", CaptureValue(tag="text", value="cum_sum over group, sorted group val")),),
                ),
            ),
            kind=DivergenceKind.ENGINE_LENIENCY,
            expected=CaptureValue(
        ...
        DivergenceManifestation(
            key=ManifestationKey(
                ...
                scenario=Scenario(
                    ...
                    execution=(("shape", CaptureValue(tag="text", value="collect expression reverse=True")),),
                ),
            ),
            kind=DivergenceKind.ENGINE_LENIENCY,
            expected=CaptureValue(
