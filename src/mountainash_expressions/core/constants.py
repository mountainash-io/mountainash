...
class CONST_VISITOR_BACKENDS(BaseIdentityConstant):
    """
...
class CONST_LOGIC_TYPES(BaseIdentityConstant):
    """
    Enumeration for different dataframe frameworks.
...
class CONST_EXPRESSION_NODE_TYPES(BaseIdentityConstant):
    """
    Enumeration for different dataframe frameworks.
...
class CONST_EXPRESSION_LOGIC_OPERATORS(BaseIdentityConstant):
