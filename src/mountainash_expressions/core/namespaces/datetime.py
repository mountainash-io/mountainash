...
class DateTimeNamespace(BaseNamespace):
    ...
    def add_years(
        self,
        years: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def add_months(
        self,
        months: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def add_days(
        self,
        days: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def add_hours(
        self,
        hours: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def add_minutes(
        self,
        minutes: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def add_seconds(
        self,
        seconds: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def truncate(
        self,
        unit: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
    ...
    def offset_by(
        self,
        offset: Union[BaseExpressionAPI, ExpressionNode, Any],
    ) -> BaseExpressionAPI:
        """
