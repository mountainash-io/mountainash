...
class SubstraitWindowArithmeticExpressionSystemProtocol(Protocol):
    ...
    def first_value(self, x: SupportedExpressions, /) -> SupportedExpressions:
    ...
    def last_value(self, x: SupportedExpressions, /) -> SupportedExpressions:
    ...
    def nth_value(self, x: SupportedExpressions, /, window_offset: SupportedExpressions, on_domain_error: Any = None) -> SupportedExpressions:
...
The `on_domain_error` option governs behavior in cases where `window_offset` is not a positive integer or `null`.
    ...
    def lead(self, x: SupportedExpressions, /) -> SupportedExpressions:
...
Example comparing the sales of the current year to the following year. `row_offset` of 1. | year | sales  | next_year_sales | | 2019 | 20.50  | 30.00           | | 2020 | 30.00  | 45.99           | | 2021 | 45.99  | null            |
    ...
    def lag(self, x: SupportedExpressions, /) -> SupportedExpressions:
