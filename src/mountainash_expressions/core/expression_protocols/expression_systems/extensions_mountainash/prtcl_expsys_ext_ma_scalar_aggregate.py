...
if TYPE_CHECKING:
    # from ...expression_api.api_namespaces import BaseExpressionNamespace as BaseExpressionAPI
    from mountainash_expressions.types import SupportedExpressions


class MountainAshScalarAggregateExpressionSystemProtocol(Protocol):
