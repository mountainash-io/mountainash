...
class ScalarStringBuilderProtocol(Protocol):
    ...
    def like(
        self,
        pattern: Union["BaseNamespace", "ExpressionNode", Any],
    ...
    def substring(
        self,
        start: Union["BaseNamespace", "ExpressionNode", Any, int],
        length: Optional[Union["BaseNamespace", "ExpressionNode", Any, int]] = None,
    ) -> "BaseNamespace":
        """Extract a substring.
    ...
    def regexp_match_substring(
        self,
        pattern: Union["BaseNamespace", "ExpressionNode", Any],
        position: Optional[Union["BaseNamespace", "ExpressionNode", Any, int]] = None,
        occurrence: Optional[Union["BaseNamespace", "ExpressionNode", Any, int]] = None,
        group: Optional[Union["BaseNamespace", "ExpressionNode", Any, int]] = None,
        case_sensitive: bool = True,
    ) -> "BaseNamespace":
    ...
    def starts_with(
        self,
        prefix: Union["BaseNamespace", "ExpressionNode", Any],
        case_sensitive: bool = True,
    ) -> "BaseNamespace":
    ...
    def ends_with(
        self,
        suffix: Union["BaseNamespace", "ExpressionNode", Any],
        case_sensitive: bool = True,
    ) -> "BaseNamespace":
    ...
    def contains(
        self,
        substring: Union["BaseNamespace", "ExpressionNode", Any],
        case_sensitive: bool = True,
    ) -> "BaseNamespace":
    ...
    def replace(
        self,
        old: Union["BaseNamespace", "ExpressionNode", Any],
        new: Union["BaseNamespace", "ExpressionNode", Any],
        case_sensitive: bool = True,
    ) -> "BaseNamespace":
    ...
    def concat_ws(
        self,
        separator: Union["BaseNamespace", "ExpressionNode", Any],
    ...
    def repeat(
        self,
        count: Union["BaseNamespace", "ExpressionNode", Any, int],
    ) -> "BaseNamespace":
    ...
    def reverse(self) -> "BaseNamespace":
        """Reverse the string.
    ...
    def replace_slice(
        self,
        start: Union["BaseNamespace", "ExpressionNode", Any, int],
        length: Union["BaseNamespace", "ExpressionNode", Any, int],
        replacement: Union["BaseNamespace", "ExpressionNode", Any],
    ) -> "BaseNamespace":
    ...
    def swapcase(self) -> "BaseNamespace":
    ...
    def capitalize(self) -> "BaseNamespace":
    ...
    def initcap(self) -> "BaseNamespace":
    ...
    def char_length(self) -> "BaseNamespace":
    ...
    def bit_length(self) -> "BaseNamespace":
    ...
    def octet_length(self) -> "BaseNamespace":
    ...
    def ltrim(
        self,
        characters: Optional[Union["BaseNamespace", "ExpressionNode", Any]] = None,
    ) -> "BaseNamespace":
    ...
    def center(
        self,
        length: Union["BaseNamespace", "ExpressionNode", Any, int],
        character: Optional[Union["BaseNamespace", "ExpressionNode", Any]] = None,
    ) -> "BaseNamespace":
