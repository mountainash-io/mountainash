...
if TYPE_CHECKING:
    from mountainash_expressions.core.expression_protocols.substrait.prtcl_scalar_set import (
...
class NarwhalsScalarSetSystem(NarwhalsBaseExpressionSystem):
    ...
    def index_in(
        self,
        needle: SupportedExpressions,
        /,
        *haystack: SupportedExpressions,
